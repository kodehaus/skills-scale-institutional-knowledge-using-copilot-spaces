...
- Passing CI and security scans (DevOps verification)
- QA Lead sign-off on testing completion and quality gates
- Release notes drafted (Release Manager)
- Rollback / mitigation plan documented (Release Manager + DevOps)
...
- [ ] Go/no-go meeting held with Release Manager, QA Lead, DevOps, and PM
...
- [ ] Run post-deploy verification tests (QA Lead + DevOps)
...
- If a deployment fails or causes a critical issue:
  ...
  - Release Manager coordinates response with QA Lead, DevOps, and PM
